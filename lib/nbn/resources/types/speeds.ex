defmodule DiffoExample.Nbn.Speeds do
  ...
  def speeds do
    [
      {12, 1}, {25, 5}, {25, 10}, {50, 20}, {100, 40}, {250, 100}, {500, 200}, {1000, 400},
      # :home_fast
      {500, 50},
      # :home_superfast
      {750, 50},
  ...
  defimpl Jason.Encoder do
    def encode(speeds, _opts) do
      Jason.OrderedObject.new(downstream: speeds.downstream, upstream: speeds.upstream, units: "Mbps")
      |> Jason.encode!()
    end
  end
end
