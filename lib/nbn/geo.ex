...
# POI locations and CSA boundaries are derived from data published by NBN Co:
#   "National Broadband Network" — fixed-line coverage dataset
#   https://data.gov.au/data/dataset/national-broadband-network
# © NBN Co Limited, licensed CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/).
# MODIFIED: each CSA boundary is a coarse convex hull computed over that POI's
# fixed-line coverage polygons and simplified; POI points are from a published
# POI address list. Fixed-wireless and satellite coverage are excluded, so some
# areas (esp. regional/hills) are understated and POIs served only by those
# technologies are omitted. Not for operational use.
# ─────────────────────────────────────────────────────────────────────────

defmodule DiffoExample.Nbn.Geo do
  @moduledoc """
  ...
  # The PlaceRef role pairing a POI to its CSA. A module attribute interns the
  # atom at compile time: `Ash.Type.Atom` reads stored values via
  # `String.to_existing_atom` (deliberately — minting atoms from DB strings is
  # an atom-table-exhaustion vector), so a role that exists ONLY as seed data
  # writes fine but fails to cast back in a cold reader. Referencing it here
  ...
  @pois [
    ...
    {"2CAM", "Campsie", %Geo.Point{coordinates: {151.10954, -33.91586}, srid: 4326}},
    {"2CAS", "Castle Hill", %Geo.Point{coordinates: {151.00514, -33.73203}, srid: 4326}},
    {"2CBT", "Campbelltown", %Geo.Point{coordinates: {150.81187, -34.068}, srid: 4326}},
    {"2CFS", "Coffs Harbour", %Geo.Point{coordinates: {153.11317, -30.29652}, srid: 4326}},
    {"2CHA", "Chatswood", %Geo.Point{coordinates: {151.18051, -33.79758}, srid: 4326}},
    {"2CRR", "Carramar", %Geo.Point{coordinates: {150.96885, -33.88823}, srid: 4326}},
    {"2CYS", "City South", %Geo.Point{coordinates: {151.20862, -33.87569}, srid: 4326}},
    {"2DAL", "Dalley", %Geo.Point{coordinates: {151.20829, -33.86289}, srid: 4326}},
    {"2DBB", "Dubbo", %Geo.Point{coordinates: {148.602, -32.24625}, srid: 4326}},
    {"2EDG", "Edgecliff", %Geo.Point{coordinates: {151.23853, -33.87948}, srid: 4326}},
    {"2FRE", "Frenchs Forest", %Geo.Point{coordinates: {151.22502, -33.75234}, srid: 4326}},
    {"2GBE", "Glebe", %Geo.Point{coordinates: {151.18851, -33.88066}, srid: 4326}},
    {"2GOS", "Gosford", %Geo.Point{coordinates: {151.34154, -33.43001}, srid: 4326}},
    {"2GRN", "Grafton", %Geo.Point{coordinates: {151.74862, -32.92603}, srid: 4326}},
    {"2HAM", "Hamilton", %Geo.Point{coordinates: {151.74864, -32.92602}, srid: 4326}},
    {"2KNS", "Kensington", %Geo.Point{coordinates: {151.22033, -33.91017}, srid: 4326}},
    {"2LAK", "Lakemba", %Geo.Point{coordinates: {151.07625, -33.92071}, srid: 4326}},
    {"2LID", "Lidcombe", %Geo.Point{coordinates: {151.04407, -33.86473}, srid: 4326}},
    {"2LIV", "Liverpool", %Geo.Point{coordinates: {150.9241, -33.92605}, srid: 4326}},
    {"2MAI", "Maitland", %Geo.Point{coordinates: {151.58691, -32.74993}, srid: 4326}},
    {"2MIR", "Miranda", %Geo.Point{coordinates: {151.10178, -34.03443}, srid: 4326}},
    {"2MOS", "Mosman", %Geo.Point{coordinates: {151.24482, -33.82917}, srid: 4326}},
    {"2MYF", "Mayfield", %Geo.Point{coordinates: {151.73495, -32.89644}, srid: 4326}},
    {"2NEW", "Newtown", %Geo.Point{coordinates: {151.17918, -33.89615}, srid: 4326}},
    {"2NWR", "Nowra-Bomaderry", %Geo.Point{coordinates: {150.60092, -34.87584}, srid: 4326}},
    {"2PAR", "Parramatta", %Geo.Point{coordinates: {151.00239, -33.81403}, srid: 4326}},
    {"2PEA", "Peakhurst", %Geo.Point{coordinates: {151.06523, -33.95274}, srid: 4326}},
    {"2PEN", "Pendle Hill", %Geo.Point{coordinates: {150.96033, -33.80471}, srid: 4326}},
    {"2PTH", "Penrith", %Geo.Point{coordinates: {150.69902, -33.75289}, srid: 4326}},
    {"2ROC", "Rockdale", %Geo.Point{coordinates: {151.13921, -33.94843}, srid: 4326}},
    {"2RYD", "Ryde", %Geo.Point{coordinates: {151.10526, -33.81357}, srid: 4326}},
    {"2STL", "St Leonards", %Geo.Point{coordinates: {151.19597, -33.82361}, srid: 4326}},
    {"2TAM", "Tamworth", %Geo.Point{coordinates: {150.93155, -31.09167}, srid: 4326}},
    {"2WAG", "Wagga Wagga", %Geo.Point{coordinates: {147.37102, -35.10636}, srid: 4326}},
    {"2WLG", "Wollongong", %Geo.Point{coordinates: {150.88995, -34.42542}, srid: 4326}},
    {"3BEN", "Bendigo", %Geo.Point{coordinates: {144.27615, -36.76145}, srid: 4326}},
    {"3BRA", "Ballarat", %Geo.Point{coordinates: {143.85459, -37.56486}, srid: 4326}},
    {"3CAU", "Caulfield", %Geo.Point{coordinates: {145.04676, -37.87601}, srid: 4326}},
    {"3CBN", "Cranbourne", %Geo.Point{coordinates: {145.28271, -38.10416}, srid: 4326}},
    {"3CTA", "Cheltenham", %Geo.Point{coordinates: {145.05554, -37.96428}, srid: 4326}},
    {"3DAD", "Dandenong", %Geo.Point{coordinates: {145.21615, -37.98698}, srid: 4326}},
    {"3EXH", "Exhibition", %Geo.Point{coordinates: {144.96969, -37.80873}, srid: 4326}},
    {"3FSR", "Footscray", %Geo.Point{coordinates: {144.89939, -37.80292}, srid: 4326}},
    {"3GEE", "Geelong", %Geo.Point{coordinates: {144.35575, -38.14905}, srid: 4326}},
    {"3HAW", "Hawthorn", %Geo.Point{coordinates: {145.03648, -37.8222}, srid: 4326}},
    {"3HRS", "Horsham", %Geo.Point{coordinates: {142.20022, -36.71336}, srid: 4326}},
    {"3KAL", "Karingal", %Geo.Point{coordinates: {145.16178, -38.15343}, srid: 4326}},
    {"3KEW", "Kew", %Geo.Point{coordinates: {145.02908, -37.80832}, srid: 4326}},
    {"3KEY", "Keysborough", %Geo.Point{coordinates: {145.16724, -37.99309}, srid: 4326}},
    {"3KGP", "Kings Park", %Geo.Point{coordinates: {144.79936, -37.7428}, srid: 4326}},
    {"3LIL", "Lilydale", %Geo.Point{coordinates: {145.35269, -37.75836}, srid: 4326}},
    {"3MTE", "Mount Eliza", %Geo.Point{coordinates: {145.09064, -38.18337}, srid: 4326}},
    {"3NBA", "North Balwyn", %Geo.Point{coordinates: {145.09283, -37.79171}, srid: 4326}},
    {"3RES", "Reservoir", %Geo.Point{coordinates: {145.00783, -37.71342}, srid: 4326}},
    {"3RWO", "Ringwood", %Geo.Point{coordinates: {145.22668, -37.81487}, srid: 4326}},
    {"3SHP", "Shepparton", %Geo.Point{coordinates: {145.3998, -36.38036}, srid: 4326}},
    {"3SMR", "South Morang", %Geo.Point{coordinates: {145.07594, -37.65775}, srid: 4326}},
    {"3STK", "St Kilda", %Geo.Point{coordinates: {144.98408, -37.86421}, srid: 4326}},
    {"3TAG", "Traralgon", %Geo.Point{coordinates: {146.53725, -38.19495}, srid: 4326}},
    {"3TMN", "Tullamarine", %Geo.Point{coordinates: {144.88357, -37.7051}, srid: 4326}},
    {"3TNB", "Thornbury", %Geo.Point{coordinates: {145.00039, -37.75824}, srid: 4326}},
    {"3WER", "Werribee", %Geo.Point{coordinates: {144.65911, -37.89578}, srid: 4326}},
    {"3WHL", "Wheelers Hill", %Geo.Point{coordinates: {145.16103, -37.90246}, srid: 4326}},
    {"4APL", "Aspley", %Geo.Point{coordinates: {153.02261, -27.3575}, srid: 4326}},
    {"4BBE", "Bundaberg", %Geo.Point{coordinates: {152.34815, -24.86594}, srid: 4326}},
    {"4BDB", "Bundamba", %Geo.Point{coordinates: {152.81832, -27.60611}, srid: 4326}},
    {"4CAB", "Caboolture", %Geo.Point{coordinates: {152.9517, -27.08539}, srid: 4326}},
    {"4CAI", "Cairns", %Geo.Point{coordinates: {145.77292, -16.92391}, srid: 4326}},
    {"4CPH", "Camp Hill", %Geo.Point{coordinates: {153.07691, -27.49337}, srid: 4326}},
    {"4EMP", "Eight Mile", %Geo.Point{coordinates: {153.10604, -27.59022}, srid: 4326}},
    {"4GDN", "Goodna", %Geo.Point{coordinates: {152.88969, -27.60591}, srid: 4326}},
    {"4IPS", "Ipswich", %Geo.Point{coordinates: {152.76109, -27.61485}, srid: 4326}},
    {"4KLG", "Petrie", %Geo.Point{coordinates: {152.97726, -27.26935}, srid: 4326}},
    {"4MKY", "Mackay", %Geo.Point{coordinates: {149.18648, -21.13953}, srid: 4326}},
    {"4MRA", "Merrimac", %Geo.Point{coordinates: {153.42689, -28.04908}, srid: 4326}},
    {"4NBR", "Nambour", %Geo.Point{coordinates: {152.96016, -26.62781}, srid: 4326}},
    {"4ROT", "Rockhampton", %Geo.Point{coordinates: {150.51274, -23.37814}, srid: 4326}},
    {"4SLA", "Slacks Creek", %Geo.Point{coordinates: {153.11821, -27.63818}, srid: 4326}},
    {"4SOP", "Southport", %Geo.Point{coordinates: {153.41376, -27.96736}, srid: 4326}},
    {"4TNS", "Townsville", %Geo.Point{coordinates: {146.81715, -19.25812}, srid: 4326}},
    {"4TOB", "Toowoomba", %Geo.Point{coordinates: {151.95679, -27.56219}, srid: 4326}},
    {"4WOB", "Woolloongabba", %Geo.Point{coordinates: {153.03646, -27.48403}, srid: 4326}},
    {"5CPK", "St Marys", %Geo.Point{coordinates: {138.58505, -34.99178}, srid: 4326}},
    {"5EDW", "Edwardstown", %Geo.Point{coordinates: {138.57207, -34.96189}, srid: 4326}},
    {"5EZB", "Elizabeth", %Geo.Point{coordinates: {138.66848, -34.72217}, srid: 4326}},
    {"5MOD", "Modbury", %Geo.Point{coordinates: {138.68723, -34.82939}, srid: 4326}},
    {"5PRO", "Prospect", %Geo.Point{coordinates: {138.60224, -34.89175}, srid: 4326}},
    {"5PTA", "Port Augusta", %Geo.Point{coordinates: {137.76237, -32.49114}, srid: 4326}},
    {"5STI", "Stirling", %Geo.Point{coordinates: {138.71665, -35.00656}, srid: 4326}},
    {"6APP", "Applecross", %Geo.Point{coordinates: {115.83841, -32.01636}, srid: 4326}},
    {"6BSD", "Bassendean", %Geo.Point{coordinates: {115.94931, -31.90486}, srid: 4326}},
    {"6CAN", "Cannington", %Geo.Point{coordinates: {115.93225, -32.01722}, srid: 4326}},
    {"6CGE", "South Coogee", %Geo.Point{coordinates: {115.79447, -32.17552}, srid: 4326}},
    {"6DBL", "Doubleview", %Geo.Point{coordinates: {115.7867, -31.89862}, srid: 4326}},
    {"6GLT", "Geraldton", %Geo.Point{coordinates: {114.61033, -28.77355}, srid: 4326}},
    {"6HIL", "Hilton", %Geo.Point{coordinates: {115.79154, -32.06278}, srid: 4326}},
    {"6KAT", "Katanning", %Geo.Point{coordinates: {117.55592, -33.68954}, srid: 4326}},
    {"6KEL", "Kelmscott", %Geo.Point{coordinates: {116.01376, -32.1133}, srid: 4326}},
    {"6MLO", "Mullaloo", %Geo.Point{coordinates: {115.75653, -31.78997}, srid: 4326}},
    {"6PNJ", "Pinjarra", %Geo.Point{coordinates: {115.87373, -32.62718}, srid: 4326}},
    {"6SUB", "Subiaco", %Geo.Point{coordinates: {115.82445, -31.94979}, srid: 4326}},
    {"7HOB", "Hobart", %Geo.Point{coordinates: {147.32718, -42.88676}, srid: 4326}},
    {"7LAU", "Launceston", %Geo.Point{coordinates: {147.13742, -41.43513}, srid: 4326}},
    {"8DRW", "Darwin", %Geo.Point{coordinates: {130.83653, -12.45857}, srid: 4326}},
    {"9CVI", "Civic", %Geo.Point{coordinates: {149.13163, -35.27376}, srid: 4326}},
    {"9QBN", "Queanbeyan", %Geo.Point{coordinates: {149.23189, -35.35361}, srid: 4326}},
  ]

  @csas [
    {"2ALB", "Albury", %Geo.Polygon{coordinates: [[{146.87793, -36.07219}, {146.87794, -36.07477}, {146.88081, -36.08735}, {146.9042, -36.09867}, {146.90953, -36.0998}, {146.93053, -36.09507}, {146.94226, -36.09}, {146.94517, -36.08821}, {146.97615, -36.06806}, {146.97576, -36.06631}, {146.97509, -36.0635}, {146.9239, -36.0607}, {146.91548, -36.06095}, {146.88564, -36.06456}, {146.88378, -36.06562}, {146.87793, -36.07219}]], srid: 4326}},
    {"2WAG", "Wagga Wagga", %Geo.Polygon{coordinates: [[{147.26908, -35.16678}, {147.47092, -35.17466}, {147.47818, -35.16283}, {147.47897, -35.15858}, {147.47921, -35.15321}, {147.45181, -35.02804}, {147.44641, -35.02735}, {147.33514, -35.04965}, {147.27691, -35.14263}, {147.2705, -35.15802}, {147.26908, -35.16678}]], srid: 4326}},
    {"2WLG", "Wollongong", %Geo.Polygon{coordinates: [[{150.84685, -34.41429}, {150.84688, -34.41442}, {150.86045, -34.44628}, {150.87368, -34.45478}, {150.87616, -34.45558}, {150.87628, -34.45549}, {150.9014, -34.43677}, {150.91002, -34.42202}, {150.89858, -34.40042}, {150.89725, -34.39866}, {150.89719, -34.39861}, {150.89675, -34.39834}, {150.89607, -34.39798}, {150.89288, -34.3972}, {150.89238, -34.39711}, {150.86697, -34.3993}, {150.85028, -34.40956}, {150.84689, -34.4141}, {150.84686, -34.41419}, {150.84685, -34.41429}]], srid: 4326}},
    {"3BEN", "Bendigo", %Geo.Polygon{coordinates: [[{144.22108, -36.80402}, {144.22403, -36.81683}, {144.23842, -36.8369}, {144.23915, -36.83774}, {144.24226, -36.83952}, {144.35757, -36.81618}, {144.37796, -36.80526}, {144.37834, -36.80323}, {144.36432, -36.77827}, {144.33487, -36.73067}, {144.28511, -36.72302}, {144.27086, -36.72793}, {144.24283, -36.74186}, {144.2425, -36.74258}, {144.23404, -36.76123}, {144.22699, -36.77946}, {144.22147, -36.80179}, {144.22108, -36.80402}]], srid: 4326}},
  ...
  def seed do
    ...
    Enum.each(@pois, fn {ref, name, point} ->
      try do
        Nbn.build_poi!(%{id: ref, name: name, location: point})
      rescue
        e -> Logger.error("Exception seeding POI #{ref}: #{inspect(e)}")
      end
    end)

    Enum.each(@csas, fn {ref, name, poly} ->
      try do
        Nbn.build_csa!(%{id: csa_id(ref), name: name, bounds: poly})
      rescue
        e -> Logger.error("Exception seeding CSA #{ref}: #{inspect(e)}")
      end
    end)

    Enum.each(@pois, fn {ref, _name, _point} ->
      try do
        # Idempotent pairing. The :build actions upsert by id, but
        # create_place_ref! does NOT upsert — so guard it. We check the
        # relationship directly off the CSA (load place_refs -> source_place)
        # rather than via the filtered API: `%Ash.NotLoaded{}` would mean we
        # failed to load, `[]` means no pairing yet, a matching ref means done.
        unless paired?(csa_id(ref), ref) do
        ...
        e -> Logger.error("Exception pairing POI #{ref} -> CSA: #{inspect(e)}")
      end
    end)
  ...
  defp csa_id(ref), do: "CSA-" <> ref

  # True if the CSA already has a PlaceRef from the given POI with the
  # interconnects role. Reads the relationship off the CSA via `load`
  # (place_refs -> source_place), defending against a missing CSA or an
  # unloaded relationship (treated as "not paired", so seeding proceeds).
  defp paired?(csa_id, poi_ref) do
    with {:ok, csa} <- Nbn.get_csa_by_id(csa_id),
         false <- is_nil(csa),
         {:ok, csa} <- Ash.load(csa, place_refs: [:source_place]),
         refs when is_list(refs) <- csa.place_refs do
      Enum.any?(refs, fn pr ->
